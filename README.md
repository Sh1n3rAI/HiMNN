...
| **SolidCond** | quasi-solid electrolytes | 10,612 | 2–5 | Ionic conductivity (σ) | [Bradford et al. 2023](https://doi.org/10.1021/acscentsci.2c01123) |
...
**Sample distribution across component counts:**
...
> For the **LiquidCond** and **SolidCond** datasets, we conducted a manual review of the original publications... *(保留原有注释内容)*
